...
import { TextAreaHistory as TextAreaHistory, type TextAreaHistoryOptions } from './history.js';
import { areEqualSets } from './utils.js';
import type { TabOut } from './tabouts.js';
